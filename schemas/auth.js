...
const registerSchema = z.object({
  username: z
    .string()
    .trim()
    .min(3, 'Le pseudo doit faire entre 3 et 24 caractères')
    .max(24, 'Le pseudo doit faire entre 3 et 24 caractères'),
...
const avatarPatchSchema = z
  ...
  .refine((d) => d.avatar !== undefined || d.avatar_color !== undefined, {
