...
function seedData(db) {
  ...
  const users = [
    { username: 'chef_camille', email: 'camille@cuistot.fr', avatar: '👩‍🍳', bio: 'Amoureuse de la cuisine du sud, huile d\'olive à volonté 🫒' },
    { username: 'leo_gourmand',  email: 'leo@cuistot.fr',     avatar: '🧑‍🍳', bio: 'Pâtissier du dimanche, mais tous les jours en vrai 🍰' },
    { username: 'nadia_veggie',  email: 'nadia@cuistot.fr',   avatar: '🥗', bio: '100% végétarien, 200% de goût 🌱' },
    { username: 'tom_bbq',       email: 'tom@cuistot.fr',     avatar: '🔥', bio: 'Roi du barbecue et des plats mijotés' },
    { username: 'demo',          email: 'demo@cuistot.fr',    avatar: '🙂', bio: 'Compte de démonstration — connecte-toi avec demo@cuistot.fr / demo123' },
  ];
  ...
  const recipes = [
    { author: 'chef_camille', title: 'Ratatouille provençale', category: 'Plat', difficulty: 'Facile', prep: 45, servings: 4, image: '🍆', photo: P + 'wrpwuu1511786491.jpg',
    ...
    { author: 'leo_gourmand', title: 'Fondant au chocolat coulant', category: 'Dessert', difficulty: 'Facile', prep: 25, servings: 6, image: '🍫', photo: P + 'twspvx1511784937.jpg',
    ...
    { author: 'nadia_veggie', title: 'Buddha bowl arc-en-ciel', category: 'Healthy', difficulty: 'Facile', prep: 20, servings: 2, image: '🥗', photo: P + '02s6gc1763799560.jpg',
    ...
    { author: 'tom_bbq', title: 'Bœuf bourguignon', category: 'Plat', difficulty: 'Moyen', prep: 180, servings: 6, image: '🍲', photo: P + 'vtqxtu1511784197.jpg',
    ...
    { author: 'leo_gourmand', title: 'Pancakes moelleux', category: 'Petit-déj', difficulty: 'Facile', prep: 20, servings: 4, image: '🥞', photo: P + 'rwuyqx1511383174.jpg',
    ...
    { author: 'chef_camille', title: 'Soupe de courge à la châtaigne', category: 'Entrée', difficulty: 'Facile', prep: 40, servings: 4, image: '🎃', photo: P + '1brbso1763585098.jpg',
    ...
    { author: 'nadia_veggie', title: 'Curry de lentilles corail', category: 'Végétarien', difficulty: 'Facile', prep: 30, servings: 4, image: '🍛', photo: P + 'uwxqwy1483389553.jpg',
  ...
  [
    ['Badge « Gourmet » exclusif', 'Un badge doré affiché sur ton profil.', '🥇', 100, -1],
    ['Sticker pack Cuistot', 'Pack de stickers cuisine à imprimer.', '🎨', 150, -1],
    ['Fiche recette premium', 'Débloque une recette de chef étoilé.', '📜', 250, -1],
    ['Tablier Cuistot brodé', 'Le vrai tablier de la communauté (édition limitée).', '🧑‍🍳', 800, 20],
    ['Livre de recettes PDF', 'Le best-of de la communauté en PDF.', '📖', 400, -1],
    ['Mise en avant 1 semaine', 'Ta recette en tête du fil pendant 7 jours.', '🚀', 600, 10],
    ['Bon d\'achat 10€ épicerie', 'À valoir chez nos partenaires.', '🛒', 1200, 5],
  ...
  [
    ['Semaine végétarienne', 'Publie une recette 100% végétarienne cette semaine.', '🌱', 60, 'végétarien', inDays(7)],
    ['Défi chocolat', 'Une recette qui contient du chocolat, et on est preneurs.', '🍫', 50, 'chocolat', inDays(10)],
    ['Cuisine d\'automne', 'Mets à l\'honneur les saveurs de saison.', '🍂', 70, 'automne', inDays(14)],
    ['Plat réconfortant', 'Un bon petit plat mijoté pour se réchauffer.', '🍲', 55, 'mijoté', inDays(12)],
